        ...
        <div className='hero_bg bg-[#d4e2f0] px-6' >
            <div className="flex flex-col justify-center items-center pt-[78px]">
                ...
                <div className="mt-12 mb-36 flex flex-col lap:flex-row content-center space-y-5 lap:space-y-0 lap:mb-40">
                    <Link to={"https://mytandem-business.netlify.app/signup"} rel="noopener noreferrer">
                        <button
                    ...
                    <button
                        className="text-base font-semibold border border-1 border-[#272746] rounded-full w-40 h-10 lap:ml-[10px]"
                        type="submit"
                    >
                        Learn more
                    </button>
