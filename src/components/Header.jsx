...
const Header = () => {
    ...
    return (
        <div className=''>
            <nav className={`fixed w-screen p-5 lap:flex lap:justify-between lap:items-center duration-300 lap:transition-none bg-[#d4e2f0]`} id="navbar">
                ...
                <div className={`text-center lap:hidden block absolute w-full duration-300 left-0 ${toggle ? 'top-[68px]' : 'top-[-340px]'}`}>
                    <div className={`p-10 flex flex-col justify-center items-center bg-[#d4e2f0] shadow-lg rounded-3xl rounded-t-none`}>
